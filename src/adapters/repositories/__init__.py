...
from src.adapters.repositories.cardapio_repository import CardapioRepository
from src.adapters.repositories.carrinho_repository import CarrinhoRepository
...
class EntityRepository:
    def __init__(self, database: Session = Depends(get_database_session)) -> None:
        ...
        self.cardapio = CardapioRepository(database_session=database)
        self.carrinho = CarrinhoRepository(database_session=database)
